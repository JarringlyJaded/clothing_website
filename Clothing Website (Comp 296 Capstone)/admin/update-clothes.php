        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Clothes" class="btn-update">
                </td>
            </tr>
            ...
            if(isset($_POST['submit'])){
                ...
                if(isset($_FILES['image']['name'])){
                    ...
                    if($image_name!=""){
                        ...
                        $dest_path = "../images/clothes/".$image_name;

                        $upload = move_uploaded_file($src_path, $dest_path);

                        if($upload==false){

                            $_SESSION['upload'] = "New Image Failed to Upload";
                            header('location:'.SITEURL.'admin/manage-clothes.php');
                            die();
                        }
                        ...
                        if($current_image!=""){
                            ...
                            if($remove==false){
                                ...
                                $_SESSION['remove-failed'] = "Unable to Remove Current Image";
                                header('location:'.SITEURL.'admin/manage-clothes.php');
                                die();
                            }
                        }
                ...
                if($res3==true){
                    ...
                    $_SESSION['update'] = "Updated Clothes Successfully";
                    header('location:'.SITEURL.'admin/manage-clothes.php');
                }
                else{

                    $_SESSION['update'] = "Failed to Update Clothes";
                    header('location:'.SITEURL.'admin/manage-clothes.php');
                }
